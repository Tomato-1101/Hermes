...
const REAL_PARAMS: Array<[string, unknown]> = [
  ...
  ['screen.findImage', { template: 'AAAA' }],
  ['screen.findImage', { template: 'AAAA', threshold: 0.9, scaleInvariant: true, region: { x: 0, y: 0, w: 50, h: 50 } }],
  ['screen.ocr', undefined],
  ['screen.ocr', { region: { x: 0, y: 0, w: 400, h: 200 }, languages: ['ja-JP', 'en-US'] }],
  ['screen.ocr', { lang: 'en-US' }],
  ...
  ['clipboard.read', null],
  ['clipboard.read', undefined],
  ['clipboard.write', { text: 'copied ✂︎ 値' }],
...
const REAL_RESULTS: Array<[string, unknown]> = [
  ...
  ['screen.findImage', { found: false, score: 0 }],
  ['screen.findImage', { found: true, score: 0.93, x: 10, y: 20, w: 40, h: 16, cx: 30, cy: 28 }],
  ['screen.ocr', { text: 'Hello\nWorld', observations: [{ text: 'Hello', confidence: 0.99, x: 1, y: 2, w: 30, h: 12 }] }],
  ['screen.ocr', { text: '', observations: [] }],
  ['mouse.click', { ok: true }],
  ['mouse.move', { ok: true }],
  ...
  ['clipboard.read', { text: 'copied ✂︎ 値' }],
  ['clipboard.read', { text: '' }],
  ['clipboard.write', { ok: true }],
